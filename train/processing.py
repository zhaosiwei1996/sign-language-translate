...
def worker(file):
    ...
    data = pd.read_excel(os.path.join(r"./npyfile/2024head-data1/", file), header=None, engine="openpyxl").iloc[1:, 1:].values
...
if __name__ == '__main__':
    ...
    for root, dirs, files in os.walk(r"./npyfile/2024head-data1/"):
        for file in files:
